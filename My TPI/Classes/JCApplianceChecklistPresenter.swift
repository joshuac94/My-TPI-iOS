...
class JCApplianceChecklistPresenter: JCApplianceChecklistPresenterProtocol {
    ...
    fileprivate func createTestingRows(inspection: ApplianceInspection) -> [JCApplianceRowViewModel] {
        return [
            ...
            JCApplianceRowViewModel(name: JCTestingRows.testWithoutLoad.description,
                                    value: inspection.testWithoutLoad ?? "",
                                    cellType: .textField,
                                    inputType: .keyboard),
            JCApplianceRowViewModel(name: JCTestingRows.testWithSWL.description,
                                    value: inspection.testWithSWL ?? "",
                                    cellType: .textField,
                                    inputType: .keyboard),
            JCApplianceRowViewModel(name: JCTestingRows.proofLoadTest.description,
                                    value: inspection.proofLoadTest ?? "",
                                    cellType: .textField,
                                    inputType: .keyboard),
    ...
    fileprivate func createSummaryRows(inspection: ApplianceInspection) -> [JCApplianceRowViewModel] {
        return [
            ...
            JCApplianceRowViewModel(name: JCApplianceSummaryRows.overallDefects.description,
                                    ...
                                    cellType: .textField,
                                    inputType: .keyboard),
            JCApplianceRowViewModel(name: JCApplianceSummaryRows.dangerToPersons.description,
                                    value: inspection.dangerToPersons ?? "",
                                    cellType: .textField,
                                    inputType: .keyboard),
